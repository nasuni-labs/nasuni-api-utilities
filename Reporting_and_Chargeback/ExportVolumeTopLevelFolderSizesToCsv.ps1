...
ForEach ($volume in $volumeList) {
    ...
    #get the filer hostnames
    $neaHostnames +=  $filerinfo.settings.network_settings.hostname
}
...
ForEach ($volume in $volumeList) {
    ...
    #get the NEA hostname for the data API
    $dataHostname =  $filerinfo.settings.network_settings.hostname
